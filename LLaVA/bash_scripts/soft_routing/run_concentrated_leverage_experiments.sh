...
TEXT_MASS_GAMMAS="${TEXT_MASS_GAMMAS:-0.25 0.5 1}"
CONCENTRATED_GAMMAS="${CONCENTRATED_GAMMAS:-1 2 4}"
VISUAL_BOOST_GAMMAS="${VISUAL_BOOST_GAMMAS:-1 2 4}"
HYBRID_GAMMAS="${HYBRID_GAMMAS:-1 2 4}"
